...
//        this.cutProgress = (int) Math.ceil(100/totalQuestion);
    ...
    /**
     * this interface is for give user the way to do something when the answer will be correct.
     */
    ...
    /**
     * this interface is for give user the way to do something when the answer will be wrong.
     */
    ...
    /**
     * this interface is for give user the way to do something when all quiz will be finished.
     */
